  ...
  return (
    <svg viewBox="0 0 455 455" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlSpace="preserve">
      <g>
        ...
        <text font-style="normal" font-weight="normal" fill="#000000" stroke="#000" stroke-width="0" x="45" y="365" id="svg_7" font-size="48" font-family="'Rounded Mplus 1c'" text-anchor="start" xmlSpace="preserve">{props.children}</text>
      </g>
