  ...
  return (
    <svg viewBox="0 0 455 455" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlSpace="preserve">
      <g>
        ...
        <text fontStyle="normal" fontWeight="normal" fill="#000000" stroke="#000" strokeWidth="0" x="35" y="365" id="svg_7" fontSize="48" fontFamily="'Rounded Mplus 1c'" textAnchor="start" xmlSpace="preserve">{props.children}</text>
      </g>
